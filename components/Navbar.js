  ...
  const viewCoinInfo = (ID)=>{
    ...
    return(
      <nav className="flex justify-between w-full h-16 items-center shadow-3xl z-50 bg-[#6E6E6E] fixed top-0">
        ...
        <div className={`md:hidden absolute top-[29%] right-16`}>
        ...
        <div className={`w-6/12 h-[10rem] bg-[#999999] flex flex-col absolute top-[82%] right-[16%] rounded-sm shadow-3xl transition-all duration-300 ease-in-out ${openMenu ? "opacity-100" : "opacity-0"} items-center justify-center text-white`}>
        ...
        <div className={`md:hidden absolute top-[29%] right-28`}>
          <i className="fas fa-search text-2xl" onClick={()=>{
            setOpenSearch(!openSearch);
            if(openMenu){
              setOpenMenu(!openMenu);
            }
        ...
        <div className={`w-8/12 h-[20rem] bg-[#999999] flex flex-col absolute top-[82%] right-[16%] rounded-sm shadow-3xl transition-all duration-300 ease-in-out ${openSearch ? "opacity-100" : "opacity-0"}`}>
