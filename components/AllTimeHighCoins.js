...
function AllTimeHigh(){
  ...
  //console.log(arr);
  const displayData = arr.map((el)=><div className="max-w-[1000px] w-11/12 mx-auto my-0 flex justify-between items-center p-3 shadow-4xl rounded-sm" key={el._id} onClick={()=>viewCoinInfo(el._id)}>
