...
function coininfo({data}){
  return(
    <div className="max-w-[700px] w-11/12 mx-auto bg-[#303030] rounded-md p-4 shadow-3xl">
      ...
      <div className="flex flex-col p-2 rounded-sm my-4 bg-[#404040]"><span>Contract address :</span><span>{data.address}</span></div>
      <div className="flex flex-col bg-[#404040] p-2 rounded-sm"><span>About Coin :</span>{data.description}</div>
            <div className="my-6">
