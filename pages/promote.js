    ...
    return(
      <div className="max-w-screen-sm w-11/12 mx-auto my-6">
        ...
        <div className="max-w-[400px] mx-auto">
          <div className="w-full mx-auto bg-gradient-to-r from-[#677e98] to-[#8a98a8] my-8 p-4 rounded-sm h-[240px] shadow-3xl">
          ...
          <div className="w-full bg-gradient-to-r from-[#677e98] to-[#8a98a8] my-12 p-4 rounded-sm shadow-3xl h-[240px]">
