    ...
    return(
      <div className="max-w-screen-sm w-11/12 mx-auto my-6">
        ...
        <div className="max-w-[400px] mx-auto">
          ...
          <Link href="mailto:naikn8113@gmail.com"><a className="bg-gray-500 w-10/12 mx-auto block text-center p-2 rounded-sm sm:mt-6 hover:bg-gray-400 text-gray-100 hover:text-black cursor-pointer">Contact support</a></Link>
        </div>
        </div>
      </div>
    )
